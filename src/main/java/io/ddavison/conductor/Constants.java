...
public class Constants {
    ...
    public static final String JVM_CONDUCTOR_TIMEOUT = "CONDUCTOR_TIMEOUT";
    public static final String JVM_CONDUCTOR_RETRIES = "CONDUCTOR_RETRIES";
    public static final String JVM_CONDUCTOR_SCREENSHOTS_ON_FAIL = "CONDUCTOR_SCREENSHOTS_ON_FAIL";
    ...
    public static final String DEFAULT_PROPERTY_SCREENSHOTS_ON_FAIL ="screenshot_on_fail";
}
